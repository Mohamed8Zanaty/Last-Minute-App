    ...
    return Row(
      children: [
        ...
        Column(
          ...
          children: const [
            Text('Ai Health Check', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: purple600)),
            SizedBox(height: 2),
            Text('Tell us about your symptoms', style: TextStyle(fontSize: 12, color: mutedText))
          ],
        ),
      ],
    );
