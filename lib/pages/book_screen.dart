...
final List<DoctorModel> doctors =[
  DoctorModel(firstName: "Sarah", lastName: "Lee", specialty: "Cardiologist", rating: 4.9, yearsExperience: 12, availableDate: "Available Now", availableTime: "2:30 PM Today", price: ""),
  DoctorModel(firstName: "Omar", lastName: "Hassan", specialty: "Dermatologist", rating: 4.8, yearsExperience: 8, availableDate: "Available Today", availableTime: "4:00 PM Today", price: ""),
  DoctorModel(firstName: "Emily", lastName: "Chen", specialty: "General Physician", rating: 4.9, yearsExperience: 15, availableDate: "Available Now", availableTime: "3:15 PM Today", price: ""),
  DoctorModel(firstName: "Michael", lastName: "Rodriguez", specialty: "Pediatrician", rating: 4.7, yearsExperience: 10, availableDate: "Available Tomorrow", availableTime: "9:00 AM Tomorrow", price:""),
        ...
        title: Row(
          children: [
            Column(
              ...
              children: [
                Text("Consult a Doctor",style: TextStyle(color: Color(0xFF3730a2),fontWeight: FontWeight.bold,fontSize: 25),),
                Text("Connect with specialists online",style: TextStyle(color: Color(0xFF3730a2),fontSize: 15),)
              ],
            )
          ],
        ),
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    MaterialButton(onPressed: (){},
                      ...
                      shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(color:  Color(0xFF7e22cd)),),child: Text("All Doctors",style:TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white),),
                    ),
                    SizedBox(width: 10,),
                    MaterialButton(onPressed: (){},
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20),
                        side: BorderSide(color:  Color(0xFF7e22cd)),),child: Text("Available Now",style:TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Color(0xFF3730a2)),),
                    ),
                    SizedBox(width: 10,),
                    MaterialButton(onPressed: (){},
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20),
                        side: BorderSide(color:  Color(0xFF7e22cd)),),child: Text("Specialists",style:TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Color(0xFF3730a2)),),
                    ),
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: Text('D${doctor.firstName[0]}${doctor.lastName[0]}',style: TextStyle(color: Colors.white,fontSize: 22,),),
                                  )
                                 /* Container(
                             ...
                             Expanded(child: Column(
                               crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                               Text('Dr. ${doctor.firstName} ${doctor.lastName}',style: TextStyle(fontWeight: FontWeight.bold,color:Color(0xFF3730a2),fontSize: 22),),
                                 Row(
                                   children: [
                                     Text(doctor.specialty,style: TextStyle(color:Color(0xFF3730a2),fontSize: 16),),
                                     Spacer(),
                                     Text('\$ ${doctor.price} per session',style: TextStyle(color:Color(0xFF3730a2),fontSize: 16),),
                                   ],
                                 ),
                                 SizedBox(height: 5,),
                                 Row(children: [
                                   Icon(Icons.star_rounded,color: Color(0xFF7e22cd),),
                                   Text(doctor.rating.toString(),style: TextStyle(color: Color(0xFF3730a2),fontWeight: FontWeight.bold,fontSize: 16),),
                                   SizedBox(width: 20,),
                                   Icon(Icons.access_time,color: Color(0xFF7e22cd),size: 20,),
                                   SizedBox(width: 5,),
                                   Text('${doctor.yearsExperience} years',style: TextStyle(color: Color(0xFF3730a2),fontSize: 16))
                                 ],
                                 )
                          ...
                          Row(
                            ...
                            children: [
                             Container(
                              alignment: Alignment.center,
                              decoration: BoxDecoration(
                                color: doctor.availableDate.toLowerCase()=="available now"?Color(0xFF7e22cd): Color(0xFFc7d2ff),
                                borderRadius: BorderRadius.circular(8),
                              ),
                              child: Padding(
                                padding: const EdgeInsets.symmetric(
                                ...
                                child: Text(doctor.availableDate,style: TextStyle(fontSize: 14,color: doctor.availableDate.toLowerCase()=="available now"?Colors.white: Color(0xFF3730a2),fontWeight: FontWeight.bold),),
                              ),),
                            SizedBox(width: 10,),
                            Icon(Icons.stop,size: 10,color: Colors.deepPurple[100]),
                            SizedBox(width: 3,),
                            Text(doctor.availableTime,style: TextStyle(color: Color(0xFF3730a2),fontSize: 14,fontWeight: FontWeight.bold),),
                          ],),
                          SizedBox(height: 10,),
                          Row(
              ...
              MaterialButton(onPressed: (){},
                ...
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(20),
                  side: BorderSide(color:  Color(0xFF7e22cd)),),child: Text("Load More Doctors",style:TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Color(0xFF3730a2)),),
              ),
              SizedBox(height: 20,)
            ],
          ),
